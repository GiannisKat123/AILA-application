...
.. py:module:: backend.database.entities
...
.. toctree::
   ...
   /backend/backend/database/entities/conversations/index
   /backend/backend/database/entities/messages/index
   /backend/backend/database/entities/user/index
